...
public class IncomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        firebaseDatabase=FirebaseDatabase.getInstance().getReference().child("Income").child(uid);

        incometotalsum=view.findViewById(R.id.total_income);
        ...
        firebaseDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot:dataSnapshot.getChildren())
                {
                    ...
                    incometotalsum.setText("                     $ "+stotalincome);
                }
            }
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Data, viewholder>(options)
        {
            @Override
            public viewholder onCreateViewHolder(ViewGroup parent, int viewType)
            {
                View view=LayoutInflater.from(parent.getContext()).inflate(R.layout.income_recyclerdata,parent,false);
                return new viewholder(view);
            }


            @Override
            protected void onBindViewHolder(viewholder holder, final int position, final Data model) {
    ...
    public static class viewholder extends RecyclerView.ViewHolder
    {
        ...
        {
            TextView textView=mview.findViewById(R.id.income_type);
            textView.setText(type);
        }
        private void setNote(String note)
        {
            TextView textView=mview.findViewById(R.id.income_note);
            textView.setText(note);
        }
        private void setDate(String date)
        {
            TextView textView=mview.findViewById(R.id.income_date);
            textView.setText(date);
        }

        private void setAmount(int amount)
        {
            TextView textView=mview.findViewById(R.id.income_amount);
